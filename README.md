# agent-infra-edge-bridge-connector-iot-vmu

## Detailed Description

agent-infra-edge-bridge-connector-iot-vmu is a iot-focused project that evaluates device telemetry and operational anomalies to improve fleet reliability and safety.  
